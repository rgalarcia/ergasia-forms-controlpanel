...
<body>
	<div class="container" style="padding: 30px 20px 20px 20px">
		...
		if (!$query) echo "<div class=\"alert alert-danger\" role=\"alert\">Error de comunicació amb la base de dades. Torni a intentar-ho més tard.</div>";
		else echo "<div class=\"alert alert-success\" role=\"alert\">Gràcies per contestar. Aquest formulari tornarà a estar disponible la setmana vinent.</div>";
		?>
	<hr>
	<footer>
