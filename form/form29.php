...
<head>
	...
	<title>Formulari 29 - Ergasia Seguretat S.L.</title>
    ...
    <h4>EMPRESA: <?php if(isset($_GET["business"])) echo $_GET["business"]; else echo "N/A"; ?></h4> 
		<form class="form-horizontal" id="answer" role="form" method="post" action="../usr/answer.php?telf=<?php if(isset($_GET["telf"])) echo $_GET["telf"]; ?>">
			...
			<h4>Uso de plataformas elevadoras</h4><br><div class="form-group">		
						<label for="question" class="col-sm-2 control-label" style="text-align: justify">acdsg</label>
						<div class="col-sm-10">
							<center>
					...
					<h4>Uso de herramientas personales</h4><br><div class="form-group">		
						<label for="question" class="col-sm-2 control-label" style="text-align: justify">eqwr</label>
						<div class="col-sm-10">
							<center>
					...
					<h4>Instalación eléctrica</h4><br><div class="form-group">		
						<label for="question" class="col-sm-2 control-label" style="text-align: justify">cxzs</label>
						<div class="col-sm-10">
							<center>
