...
<head>
	...
	<title>Formulari 8 - Ergasia Seguretat S.L.</title>
...
<body>
    ...
    <h4>Empresa: <?php isset($business)?$business:"N/A" ?></h4> 
		<form class="form-horizontal" role="form" method="post" action="../usr/answer.php">
			...
			<h4>Manipulación de objetos</h4><br><div class="form-group">		
						<label for="name" class="col-sm-2 control-label">vcbc</label>
						<div class="col-sm-10">
							<center>
					...
					<h4>Uso de herramientas personales</h4><br><div class="form-group">		
						<label for="name" class="col-sm-2 control-label">fghfgh</label>
						<div class="col-sm-10">
							<center>
