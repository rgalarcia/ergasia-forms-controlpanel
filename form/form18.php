...
<head>
	...
	<title>Formulari 18 - Ergasia Seguretat S.L.</title>
...
<body>
    ...
    <h4>EMPRESA: <?php if(isset($_GET["business"])) echo $_GET["business"]; else echo "N/A"; ?></h4> 
		<form class="form-horizontal" id="answer" role="form" method="post" action="../usr/answer.php">
			...
			<hr>
			<h4>LEYENDA:</h4>
			<h5>N/A: No aplicable.</h5>
			<h5>B: Bien, condiciones correctas.</h5>
			<h5>M: Mal, faltan condiciones de seguridad, se anota en la última página las medidas solicitadas y tomadas.</h5>
			<hr>
			<div class="form-group" style="padding:20px">
			<h4>Uso de plataformas elevadoras</h4><br><div class="form-group">		
						<label for="name" class="col-sm-2 control-label">ghjk</label>
						<div class="col-sm-10">
							<center>
					...
					<h4>Uso de herramientas personales</h4><br><div class="form-group">		
						<label for="name" class="col-sm-2 control-label">hjkl</label>
						<div class="col-sm-10">
							<center>
							<label class="radio-inline"><input type="radio" value="N/A" name="10aoptradio">N/A&nbsp;</label>
							<label class="radio-inline"><input type="radio" value="B"name="10aoptradio">B&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
							<label class="radio-inline"><input type="radio" value="M"name="10aoptradio">M&nbsp;&nbsp;&nbsp;</label><br>
							<br>
							<p>Valor del riesgo</p>
							
							<label class="radio-inline"><input type="radio" value="Alto" name="10boptradio">Alto</label>
							<label class="radio-inline"><input type="radio" value="Medio" name="10boptradio">Medio</label>
							<label class="radio-inline"><input type="radio" value="Bajo" name="10boptradio">Bajo</label>
						</center>
						</div>
					</div>
					<br>
