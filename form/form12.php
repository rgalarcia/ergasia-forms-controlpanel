...
<head>
	...
	<title>Formulari 12 - Ergasia Seguretat S.L.</title>
...
<body>
    ...
    <h4>EMPRESA: <?php if(isset($_GET["business"])) echo $_GET["business"]; else echo "N/A"; ?></h4> 
		<form class="form-horizontal" id="answer" role="form" method="post" action="../usr/answer.php">
			<h4>OBRA:</h4> 
			<div class="col-sm-10">
				<input type="text" class="form-control" id="obra" name="obra" placeholder="Nombre de la obra" value="">
			</div>
			<br>
			<hr>
			<div class="form-group" style="padding:20px">
			<h4>Incendios</h4><br><div class="form-group">		
						<label for="name" class="col-sm-2 control-label">ads</label>
						<div class="col-sm-10">
							<center>
							<label class="radio-inline"><input type="radio" value="N/A" name="02aoptradio">N/A&nbsp;</label>
							<label class="radio-inline"><input type="radio" value="B"name="02aoptradio">B&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
							<label class="radio-inline"><input type="radio" value="M"name="02aoptradio">M&nbsp;&nbsp;&nbsp;</label><br>
							<br>
							<p>Valor del riesgo</p>
							
							<label class="radio-inline"><input type="radio" value="Alto" name="02boptradio">Alto</label>
							<label class="radio-inline"><input type="radio" value="Medio" name="02boptradio">Medio</label>
							<label class="radio-inline"><input type="radio" value="Bajo" name="02boptradio">Bajo</label>
						</center>
						</div>
					</div>
