...
<head>
	...
	<title>Formulari 31 - Ergasia Seguretat S.L.</title>
    ...
    <h4>EMPRESA: <?php if(isset($_GET["business"])) echo $_GET["business"]; else echo "N/A"; ?></h4> 
		<form class="form-horizontal" id="answer" role="form" method="post" action="../usr/answer.php?telf=<?php if(isset($_GET["telf"])) echo $_GET["telf"]; ?>">
			...
			<h4>Uso de plataformas elevadoras</h4><br><div class="form-group">		
						<label for="question" class="col-sm-2 control-label" style="text-align: justify">awdgs</label>
						<div class="col-sm-10">
							<center>
					...
					<div class="form-group">		
						<label for="question" class="col-sm-2 control-label" style="text-align: justify">agsd</label>
						<div class="col-sm-10">
							<center>
					...
					<h4>Uso de escaleras de mano</h4><br><div class="form-group">		
						<label for="question" class="col-sm-2 control-label" style="text-align: justify">dasfew</label>
						<div class="col-sm-10">
							<center>
					...
					<br>
					<div class="form-group">		
						<label for="question" class="col-sm-2 control-label" style="text-align: justify">erwwet</label>
						<div class="col-sm-10">
							<center>
					...
					<br>
					<div class="form-group">		
						<label for="question" class="col-sm-2 control-label" style="text-align: justify">cvn</label>
						<div class="col-sm-10">
							<center>
					...
					<h4>Incendios</h4><br><div class="form-group">		
						<label for="question" class="col-sm-2 control-label" style="text-align: justify">gfhderts</label>
						<div class="col-sm-10">
							<center>
					...
					<br>
					<div class="form-group">		
						<label for="question" class="col-sm-2 control-label" style="text-align: justify">iuoylhjk</label>
						<div class="col-sm-10">
							<center>
