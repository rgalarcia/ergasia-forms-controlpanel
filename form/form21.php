...
<head>
	...
	<title>Formulari 21 - Ergasia Seguretat S.L.</title>
		...
		<h4>EMPRESA: <?php if(isset($_GET["business"])) echo $_GET["business"]; else echo "N/A"; ?></h4> 
			<form class="form-horizontal" id="answer" role="form" method="post" action="../usr/answer.php">
				...
				<h4>Incendios</h4><br><div class="form-group">		
										<label for="name" class="col-sm-2 control-label">Ajajajaj</label>
										<div class="col-sm-10">
											<center>
									...
									<br>
									<h4>Fracàs escolar</h4><br><div class="form-group">		
										<label for="name" class="col-sm-2 control-label">lolee</label>
										<div class="col-sm-10">
											<center>
